...
namespace ITMLib
{
	namespace Engine
	{
      ...
      bool Pick(const ITMScene<TVoxel,TIndex> *scene, const ITMPose *pose, const ITMIntrinsics *intrinsics, const Vector2i& imgSize, const Vector2f *minmaxdata, int x, int y, Vector3f& hitPoint) const;
		};
      ...
      bool Pick(const ITMScene<TVoxel,ITMVoxelBlockHash> *scene, const ITMPose *pose, const ITMIntrinsics *intrinsics, const Vector2i& imgSize, const Vector2f *minmaxdata, int x, int y, Vector3f& hitPoint) const;
		};
	}
}
